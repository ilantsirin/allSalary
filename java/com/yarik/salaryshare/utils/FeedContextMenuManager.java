...
public class FeedContextMenuManager implements View.OnAttachStateChangeListener, ListView.OnScrollListener {
    ...
    public void toggleContextMenuFromView(View openingView, Salary salary, FeedContextMenu.OnFeedContextMenuItemClickListener listener) {
        if (contextMenuView == null) {
            showContextMenuFromView(openingView, salary, listener);
        } else {
            hideContextMenu();
        }
    }

    private void showContextMenuFromView(final View openingView, Salary salary, FeedContextMenu.OnFeedContextMenuItemClickListener listener) {
        if (!isContextMenuShowing) {
            isContextMenuShowing = true;
            contextMenuView = new FeedContextMenu(openingView.getContext(), salary.isFavorited());
            contextMenuView.bindToItem(salary);
